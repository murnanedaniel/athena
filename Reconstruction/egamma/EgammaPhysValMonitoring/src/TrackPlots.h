...
class TrackPlots:public PlotBase {
    public:
      ...
      void Set_d0_Bins(std::vector<double> d0Range);
      void Set_d0sig_Bins(std::vector<double> d0sigRange);
      void Set_z0_Bins(std::vector<double> z0Range);
      ...
      std::vector<double> Get_d0_Bins(){ return m_d0Range; };
      std::vector<double> Get_d0sig_Bins(){ return m_d0sigRange; };
      std::vector<double> Get_z0_Bins(){ return m_z0Range; };
