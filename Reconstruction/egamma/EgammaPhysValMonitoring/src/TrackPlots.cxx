...
void TrackPlots::initializePlots(){
  ...
  void TrackPlots::Set_d0_Bins(std::vector<double> d0Range)
  {
    m_d0Range = d0Range;
  }
  void TrackPlots::Set_d0sig_Bins(std::vector<double> d0sigRange)
  {
    m_d0sigRange = d0sigRange;
  }

  void TrackPlots::Set_z0_Bins(std::vector<double> z0Range)
  {
    m_z0Range = z0Range;
  }
