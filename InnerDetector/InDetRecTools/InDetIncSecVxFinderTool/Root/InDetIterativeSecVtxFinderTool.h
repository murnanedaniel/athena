...
//                        const xAOD::Vertex & vertex  ) const;
   ...
   Gaudi::Property<int> m_filterLevel{this,"VertexFilterLevel",5,""} ;
   Gaudi::Property<double> m_significanceCutSeeding{this, "significanceCutSeeding", 9., ""};
   Gaudi::Property<double> m_maximumChi2cutForSeeding{this, "maxCompatibilityCutSeeding",36., ""};
   Gaudi::Property<double> m_minWghtAtVtx{this, "minTrackWeightAtVtx",0., ""};
   Gaudi::Property<double> m_maxVertices{this, "maxVertices",25, ""};
